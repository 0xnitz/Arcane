...
Thread::Thread(Process& process, const ThreadCreationFlags creation_flags, LPTHREAD_START_ROUTINE thread_start, LPVOID param) :
	m_handle(create_thread(process, creation_flags, thread_start, param)),
...
NO_DISCARD SmartHandle Thread::create_thread(Process& process, const ThreadCreationFlags creation_flags, LPTHREAD_START_ROUTINE thread_start, LPVOID param)
{
